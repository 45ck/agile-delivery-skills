...
<p align="center">
  <img src="logo.svg" alt="agile-delivery-skills logo" width="128" height="128" />
</p>

<p align="center">
  <img src="banner.svg" alt="agile-delivery-skills banner" width="100%" />
</p>

<p align="center">
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="MIT License" /></a>
  <img src="https://img.shields.io/badge/skills-11-b91c1c" alt="11 skills" />
  <img src="https://img.shields.io/badge/focus-agile%20delivery-991b1b" alt="agile delivery" />
</p>

A platform-neutral agile delivery skill pack for backlog shaping, sprint goals, acceptance-driven planning, retrospectives, blockers, and team delivery discipline.
...
```bash
git clone https://github.com/45ck/agile-delivery-skills.git
cd agile-delivery-skills
bash install.sh
```
...
```text
/backlog-groomer next sprint candidates
/story-splitting-advisor oversized feature
/sprint-goal-writer sprint 14 planning
/retrospective-pattern-finder last three sprints
/acceptance-driven-planner release candidate
/blocker-escalation-advisor stalled delivery item
```
